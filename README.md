...
This repository contains a Pine Script source file saved as `pine_script_project_strategy.txt` so it opens easily on GitHub and can be copied into TradingView.

The script focuses on EMA, SMA, WMA, RSI, Supertrend, Bollinger Bands. It is useful for TradingView chart study, Pine Script learning, technical-analysis research, alerts, and strategy development workflows.

For custom TradingView Pine Script development, visit https://jayadevrana.com.

## Strategy Description

new file gives traders a practical chart workflow around EMA, SMA, WMA, RSI. The source is kept readable in a single `.txt` file so the logic can be reviewed, copied, and adapted inside TradingView.
...
3. Copy the code from `pine_script_project_strategy.txt`.
